...
[![GitHub build status: CI](https://img.shields.io/github/actions/workflow/status/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/ci.yml?branch=main&label=CI&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/actions?query=workflow%3ACI)
[![GitHub build status: Quality Assurance](https://img.shields.io/github/actions/workflow/status/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/qa.yml?branch=main&label=QA&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/actions?query=workflow%3A%22Quality+Assurance%22)
[![GitHub issues: bugs](https://img.shields.io/github/issues/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/bug?label=Bug%20Reports&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/QuingKhaos/frozen-food-fulgora-coralmium-agriculture?label=Pull%20Requests&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/frozen-food-fulgora-coralmium-agriculture/pulls)

# Frozen Food for Wooden Fulgora: Coralmium Agriculture

Adds [frozen food](https://mods.factorio.com/mod/FrozenFood) support to [Coralmium Agriculture](https://mods.factorio.com/mod/fulgora-coralmium-agriculture).
